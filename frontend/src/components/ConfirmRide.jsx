...
const ConfirmRide = (props) => {
  return (
    <div>
        ...
        <h3 className="text-2xl font-semibold mb-2">Confirm you ride</h3>
        ...
        <div className='w-full mt-5'>
            ...
            }} className='w-full mt-5 bg-green-600 rounded-lg text-white font-semibold p-2'>Confirm your Ride</button>
        </div>
    </div>
